      ...
      <Container className="my-5">
        ...
        <Row className="align-items-center mb-5">
          <Col md={6}>
            ...
            <p className="text-muted">
              At ExploreTours, we specialize in crafting unique and exciting
              travel experiences for adventure seekers, families, and solo
              travelers. With years of expertise, we offer hassle-free tours to
              the world's most breathtaking destinations.
            </p>
            <p className="text-muted">
              Our mission is to provide safe, fun, and enriching journeys that
        ...
        <Row className="align-items-center mb-5 flex-md-row-reverse">
          <Col md={6}>
            ...
            <p className="text-muted">
              We believe in making travel accessible, sustainable, and filled
        ...
        <Row>
          <Col md={4} className="mb-3">
            ...
            <p className="text-muted">
              Recognized as a top travel company with years of excellent
              service.
            </p>
          </Col>
          <Col md={4} className="mb-3">
        ...
        <div className="text-center mt-5">
          ...
          <p className="text-muted">
            Join us for an unforgettable travel experience.
          </p>
          <Button variant="primary" size="lg" href="/contactus">
            Contact Us
          </Button>
        </div>
      </Container>
